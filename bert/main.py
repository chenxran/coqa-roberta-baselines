...
from utils.data_utils import CoQADataset
...
#     tokenizer("Who want to go to school.", "I want to go to school.")
...
def get_args():
    ...
    parser.add_argument('--cuda_id', type=int, default=0, help='Specify a CUDA id.')
    ...
    group.add_argument('--max_length', type=int, default=512, help='Whether to dropout word.')
    group.add_argument('--gradient_accumulation_steps', type=int, default=6, help='optimize X batches a time')

    # Optimizer
    group = parser.add_argument_group('training_spec')
    group.add_argument('--optimizer', type=str, default='adamw', help='Set optimizer.')
    group.add_argument('--learning_rate', type=float, default=5e-5, help='Set learning rate for SGD.')
    group.add_argument('--grad_clipping', type=float, default=1.0, help='Whether to use grad clipping.')
    ...
    group.add_argument('--batch_size', type=int, default=8, help='Set batch size.')
    group.add_argument('--max_epochs', type=int, default=4, help='Set number of total epochs.')
    group.add_argument('--verbose', type=int, default=1, help='Print every X batches.')
    group.add_argument('--shuffle', type=str2bool, default=False,
