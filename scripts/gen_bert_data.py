...
from transformers import BertTokenizer, RobertaTokenizer, BertTokenizerFast, RobertaTokenizerFast
...
def process(text):
    ...
    output['word'] = tokenizer.convert_ids_to_tokens(encoding.input_ids)
    output['offsets'] = encoding.offset_mapping
